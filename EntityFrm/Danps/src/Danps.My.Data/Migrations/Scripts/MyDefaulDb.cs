...
{
    public class MyDefaulDb
	{
		public static string INIT => @"exec dbo.st_my_default_db";
		public static string DROP => @"drop procedure if exists dbo.st_my_default_db";
		public static string SQL => @"CREATE Procedure dbo.st_my_default_db AS
BEGIN
